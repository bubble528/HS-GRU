...
def get_batch_new(random_list, data, eoq, eos, type='train', element=50, batch_size=50, max_len=50):
    ...
    if type == 'train':
        ...
        for i in train_list:
            ...
            if len(i)>max_len:
                listofzeros[max_len - 2] = eoq
                listofzeros[max_len-1] = eos
...
# uses data/new_batch/*
def get_batch(random_list, data, eoq, eos, type='train', element=50, batch_size=50, max_len=50):
    ...
    if type == 'train':
        ...
        return x_batch.T, y_batch.T, batch_max_len, random_list
